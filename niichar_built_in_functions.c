...
/**
 * niichar_exit - function to implement in-built exit
...
/**
 * niichar_env - function to implement in-built env
 * @parsed_commands: parsed command to execute
 * Return: int
 */
...
/**
 * niichar_cd - function to implement in-built cd
 * @parsed_commands: parsed command to execute
 * Return: int
 */
...
/**
 * niichar_echo - function to implement in-built echo
 * @parsed_commands: parsed command to execute
 * Return: int
 */
